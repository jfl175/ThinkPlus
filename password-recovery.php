...
$mail->Username = 'ramsudhakarreddy123@gmail.com';    // SMTP username
$mail->Password = '8106705454'; // SMTP password
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to
$mail->setFrom('ramsudhakarreddy123@gmail.com','Ramasudhakarreddy');
